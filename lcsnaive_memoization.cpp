/* 
this program is only for the implementation of the naive recursive algorithm with memoization for the lcs problem. 
...
class LCS 
{
    public:
        ...
        int c [ 30 ] [ 30 ] ; // have given the maximum size of the memo as 30 since do nto think will consider strings over 
